...
const ListNews = ({ news, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                  ...
                  <div key={item.id}>
                    <CardBox hasTable isList className={'rounded shadow-none'}>
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          <Link
                              href={`/news/news-view/?id=${item.id}`}
                              className={
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ dataFormatter.dateTimeFormatter(item.published_date) }</p>
                            </div>
